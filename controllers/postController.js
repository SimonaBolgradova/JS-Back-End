...
const { createPost, getPostById, updatePost, vote } = require('../services/postService');
const {mapErrors, postViewModel} = require('../util/mappers');

  router.get('/create',isUser, (req, res) => {
    res.render('cerate',{title:'Create Page'})
});
...
router.post('/create', isUser(),async (req, res)=>{
    ...
    try{
        ...
        res.renedr('create',{title:'Create Post', errors,data:post})
...
router.post('/edit/:id',isUser(),async (req,res)=>{
    ...
    try{
        ...
        const errors = mapErrors(err);
        existing._id = id;
        res.render('edit',{title:'Edit Post',post: existing,errors})
    }
})
